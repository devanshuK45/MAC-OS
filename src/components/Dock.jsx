  ...
  return (
    <footer className="dock">
      ...
      <div
        onClick={() => {
          window.open(
            "https://mail.google.com/mail/?view=cm&fs=1&to=devanshuwas@example.com",
            "_blank")
        }}
        className="icon mail"><img src="/doc-icons/mail.svg" alt="" /></div>
      <div
        onClick={() => { window.open("https://in.linkedin.com/in/devanshu-kinkar", "_blank") }}
        className="icon link"><img src="/doc-icons/link.svg" alt="" /></div>
      <div onClick={() => { setWindowState(state => ({ ...state, cli: true })) }}
